Shader /*ase_name*/ "Hidden/Atmospheric Scattering/Aerial Pespective" /*end*/
{
	Properties
	{
		/*ase_props*/
	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Aerial Perspective:false,true:true
				true:SetDefine:_AERIAL_PERSPECTIVE 1
				true:SetDefine:pragma shader_feature _ _AP_DEBUG_EXTINCTION _AP_DEBUG_INSCATTERING
				true:SetDefine:pragma multi_compile _ _LIGHT_SHAFT
				false:RemoveDefine:_AERIAL_PERSPECTIVE 1
				false:RemoveDefine:pragma shader_feature _ _AP_DEBUG_EXTINCTION _AP_DEBUG_INSCATTERING
				false:RemoveDefine:pragma multi_compile _ _LIGHT_SHAFT
		...
		*/
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN /*ase_frag_input*/ ) : SV_Target
			{
                ...
                //float4 screenPos = ComputeScreenPos(IN.clipPos);
				APPLY_SCATTERING(color,inputData.positionWS,ComputeScreenPos(positionCS));
